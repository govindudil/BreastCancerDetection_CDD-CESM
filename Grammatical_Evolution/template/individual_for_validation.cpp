...
// #define EXPRESSION ifLessThan(Dim[i][3], Dim[i][42], tanh(ifLessThan(Dim[i][42], Dim[i][15], Dim[i][24], Dim[i][9])), Dim[i][2])
// #define EXPRESSION ifLessThan((Dim[i][12]), ifLessThan(Dim[i][22], protected_abs((Dim[i][9] * Dim[i][50])), Dim[i][12], Dim[i][45]), ifLessThan(Dim[i][7], Dim[i][9], ifLessThan(Dim[i][20], ifLessThan(Dim[i][4], Dim[i][42], Dim[i][37], Dim[i][42]), Dim[i][16], Dim[i][29]), Dim[i][0]), Dim[i][37])
// #define EXPRESSION ifLessThan(ifLessThan(Dim[i][25], Dim[i][38], Dim[i][12], Dim[i][45]), ifLessThan(Dim[i][7], Dim[i][9], Dim[i][25], Dim[i][18]), ifLessThan(Dim[i][45], ifLessThan(Dim[i][7], Dim[i][9], Dim[i][25], Dim[i][26]), Dim[i][29], Dim[i][35]), Dim[i][34])
#define EXPRESSION \
 protected_abs((Dim[i][9] * Dim[i][50]))
